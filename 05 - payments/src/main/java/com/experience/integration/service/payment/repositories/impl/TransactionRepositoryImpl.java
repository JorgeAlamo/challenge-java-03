...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    public TransactionRepositoryImpl(Builder builder,
                                     @Value("${service.url.api.servicePayment}")
                                             String urlApiServicePayment){
        log.info("urlApiTransaction = " + urlApiServicePayment + "/transactions");

        this.webClient = builder.baseUrl(urlApiServicePayment + "/transactions")
                .clientConnector(
    ...
    @Override
    public Mono<Transaction> save(Transaction transaction, String authToken) {
        return this.webClient.post()
                ...
                .doOnError(inf -> log.info("LOG ERROR: Mono<Transaction> save"))
                .doOnSuccess(inf -> log.info("LOG SUCCESS: Mono<Transaction> save"));
    }
}
